...
$tantang = "Officiis eligendi itaque labore et dolorum mollitia officiis optio vero. Quisquam sunt adipisci omnis et ut. Nulla accusantium dolor incidunt officia tempore. Et eius omnis.";
$keterangan_skill = "Necessitatibus eius consequatur ex aliquid fuga eum quidem sint consectetur velit";
...
if ($result->num_rows > 0) {
    ...
    $email = $row['email'];
    $kota = $row['kota'];
    $freelance = $row['freelance'] ? 'Available' : 'Not Available';
...
<head>
  ...
  <title>About - <?php echo $nama_lengkap; ?></title>
  <meta name="description" content="<?php echo $deskripsi_profesi; ?>">
  <meta name="keywords" content="<?php echo $profesi; ?>, about, portfolio">
...
<body class="about-page">
  ...
  <main class="main">
    ...
    <section id="about" class="about section">
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-4">
            <img src="<?php echo $url_foto; ?>" class="img-fluid" alt="<?php echo $nama_lengkap; ?>">
          </div>
            ...
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span><?php echo $tgl_lahir; ?></span></li>
                  <?php endif; ?>
                  ...
                  <?php endif; ?>
                  <?php if (!empty($hp)): ?>
                  <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span><?php echo $hp; ?></span></li>
                  <?php endif; ?>
                  <?php if (!empty($kota)): ?>
                  <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span><?php echo $kota; ?></span></li>
                  <?php endif; ?>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  ...
                  <?php endif; ?>
                  <?php if (!empty($gelar)): ?>
                  <li><i class="bi bi-chevron-right"></i> <strong>Degree:</strong> <span><?php echo $gelar; ?></span></li>
                  <?php endif; ?>
                  <?php if (!empty($email)): ?>
                  <li><i class="bi bi-chevron-right"></i> <strong>Email:</strong> <span><?php echo $email; ?></span></li>
                  <?php endif; ?>
                  <?php if (isset($freelance)): ?>
    ...
    <section id="stats" class="stats section">
      ...
      <div class="container section-title" data-aos="fade-up">
        <h2>Facts</h2>
        <p>Some interesting facts about my professional journey</p>
      </div><!-- End Section Title -->
